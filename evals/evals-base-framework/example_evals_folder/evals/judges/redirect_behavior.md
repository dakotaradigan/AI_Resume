...
If you cannot make a confident judgment — for example, the query category seems wrong, the response is too ambiguous to evaluate, or there is insufficient context — return "unknown" instead of guessing.

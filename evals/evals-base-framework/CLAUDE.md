...
- `JUDGE_SYSTEM_DESIGN_TEMPLATE.md` — Template for documenting judge pipeline architecture decisions.
...
├── datasets/              ← Test datasets (tasks with expected behaviors)
│   └── README.md
├── judges/                ← LLM-as-judge prompts
│   └── README.md
├── scripts/               ← Eval runner scripts (code-based graders, automation)
│   └── README.md
